...
orb_l(lm)=1 ! if wrong orbital it means all orbitals
goto 31
...
if (trim(str2).eq.'px') orb_l(2)=1     ! LZ added
if (trim(str2).eq.'py') orb_l(3)=1     ! LZ added
if (trim(str2).eq.'pz') orb_l(4)=1     ! LZ added 

if (trim(str2).eq.'d1') orb_l(5)=1     ! LZ added  dxy
if (trim(str2).eq.'d2') orb_l(6)=1     ! LZ added  dyz
if (trim(str2).eq.'d3') orb_l(7)=1     ! LZ added
if (trim(str2).eq.'d4') orb_l(8)=1     ! LZ added  dzx
if (trim(str2).eq.'d5') orb_l(9)=1     ! LZ added 

if (trim(str2).eq.'d1d3d5') then       ! LZ added, only for MoS2
  orb_l(5)=1
  orb_l(7)=1
  orb_l(9)=1
endif

if (trim(str2).eq.'d2d4') then         ! LZ added, only for MoS2
  orb_l(6)=1
  orb_l(8)=1
endif
